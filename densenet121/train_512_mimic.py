# Train model with MIMICIII, 512x512, CLAHE, MC Dropout = 0.5
...
train_x, train_y, val_x, val_y = prepare_dataset(pd.read_csv('../cxr/mimic3.csv'))
...
net = train(net, criterion, optimizer, train_loader, test_loader, 100, device, disp_freq, val_freq, save_dir="/media/ethan/model_saves/densenet_512/")